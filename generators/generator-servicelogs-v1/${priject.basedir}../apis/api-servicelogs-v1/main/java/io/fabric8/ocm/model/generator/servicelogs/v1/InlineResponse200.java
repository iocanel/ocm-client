...
public class InlineResponse200 {
  @JsonProperty("items")
  private List<LogEntry> items = null;
  ...
  public InlineResponse200 items(List<LogEntry> items) {
    this.items = items;
    return this;
  }

  public InlineResponse200 addItemsItem(LogEntry itemsItem) {
    if (this.items == null) {
   ...
   * @return items
  **/
  @Schema(description = "Retrieved list of Cluster logs. ")
