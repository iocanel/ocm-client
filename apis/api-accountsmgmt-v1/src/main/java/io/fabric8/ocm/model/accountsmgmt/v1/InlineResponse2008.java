...
public class InlineResponse2008 {
  ...
  public InlineResponse2008 items(List<Registry> items) {
    this.items = items;
    return this;
  }

  public InlineResponse2008 addItemsItem(Registry itemsItem) {
    if (this.items == null) {
   ...
   * @return items
  **/
  @Schema(description = "Retrieved list of registries. ")
