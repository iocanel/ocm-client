...
public class InlineResponse20014 {
  ...
  public InlineResponse20014 items(List<ReservedResource> items) {
    this.items = items;
    return this;
  }

  public InlineResponse20014 addItemsItem(ReservedResource itemsItem) {
    if (this.items == null) {
   ...
   * @return items
  **/
  @Schema(description = "Retrieved list of reserved resources. ")
