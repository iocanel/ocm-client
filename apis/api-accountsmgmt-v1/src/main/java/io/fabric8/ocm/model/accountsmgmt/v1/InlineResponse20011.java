...
public class InlineResponse20011 {
  @JsonProperty("items")
  private List<SkuRule> items = null;
  ...
  public InlineResponse20011 items(List<SkuRule> items) {
    this.items = items;
    return this;
  }

  public InlineResponse20011 addItemsItem(SkuRule itemsItem) {
    if (this.items == null) {
   ...
   * @return items
  **/
  @Schema(description = "Retrieved list of Sku Rules. ")
  public List<SkuRule> getItems() {
    return items;
  }

  public void setItems(List<SkuRule> items) {
    this.items = items;
  }
  ...
  **/
  ...
  public InlineResponse20011 size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse20011 total(Integer total) {
    this.total = total;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.items, inlineResponse20011.items) &&
        Objects.equals(this.page, inlineResponse20011.page) &&
        Objects.equals(this.size, inlineResponse20011.size) &&
