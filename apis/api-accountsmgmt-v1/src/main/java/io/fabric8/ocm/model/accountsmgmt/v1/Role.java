...
public class Role {
   ...
   * @return kind
  **/
  @Schema(description = "Indicates the type of this object. Will be 'Role' if this is a complete object or 'RoleLink' if it is just a link. ")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(kind, id, href, name, permissions);
  }
