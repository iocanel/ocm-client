...
public class InlineResponse20013 {
  ...
  public InlineResponse20013 items(List<Subscription> items) {
    this.items = items;
    return this;
  }

  public InlineResponse20013 addItemsItem(Subscription itemsItem) {
    if (this.items == null) {
   ...
   * @return items
  **/
  @Schema(description = "Retrieved list of subscriptions. ")
