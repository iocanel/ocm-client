...
public class InlineResponse2007 {
  ...
  public InlineResponse2007 items(List<Permission> items) {
    this.items = items;
    return this;
  }

  public InlineResponse2007 addItemsItem(Permission itemsItem) {
    if (this.items == null) {
   ...
   * @return items
  **/
  @Schema(description = "Retrieved list of permissions. ")
