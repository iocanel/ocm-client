...
public class InlineResponse2009 {
  ...
  public InlineResponse2009 items(List<RegistryCredential> items) {
    this.items = items;
    return this;
  }

  public InlineResponse2009 addItemsItem(RegistryCredential itemsItem) {
    if (this.items == null) {
   ...
   * @return items
  **/
  @Schema(description = "Retrieved list of registry credentials. ")
