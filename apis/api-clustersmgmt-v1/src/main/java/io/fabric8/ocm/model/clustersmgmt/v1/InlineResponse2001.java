...
public class InlineResponse2001 {
  @JsonProperty("items")
  private List<AWSInfrastructureAccessRole> items = null;
  ...
  public InlineResponse2001 items(List<AWSInfrastructureAccessRole> items) {
    this.items = items;
    return this;
  }

  public InlineResponse2001 addItemsItem(AWSInfrastructureAccessRole itemsItem) {
    if (this.items == null) {
   ...
   * @return items
  **/
  @Schema(description = "Retrieved list of roles. ")
  public List<AWSInfrastructureAccessRole> getItems() {
    return items;
  }

  public void setItems(List<AWSInfrastructureAccessRole> items) {
    this.items = items;
  }
