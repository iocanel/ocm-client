...
public class InlineResponse20016 {
  @JsonProperty("items")
  private List<UpgradePolicy> items = null;
  ...
  public InlineResponse20016 items(List<UpgradePolicy> items) {
    this.items = items;
    return this;
  }

  public InlineResponse20016 addItemsItem(UpgradePolicy itemsItem) {
    if (this.items == null) {
   ...
   * @return items
  **/
  @Schema(description = "Retrieved list of upgrade policy. ")
  public List<UpgradePolicy> getItems() {
    return items;
  }

  public void setItems(List<UpgradePolicy> items) {
    this.items = items;
  }

  public InlineResponse20016 page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse20016 size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.items, inlineResponse20016.items) &&
        Objects.equals(this.page, inlineResponse20016.page) &&
        Objects.equals(this.size, inlineResponse20016.size) &&
