...
public class CloudProvider {
   ...
   * @return kind
  **/
  @Schema(description = "Indicates the type of this object. Will be 'CloudProvider' if this is a complete object or 'CloudProviderLink' if it is just a link. ")
  ...
  **/
  ...
  public CloudProvider href(String href) {
    this.href = href;
    return this;
  }
  ...
  **/
   ...
   * @return displayName
  **/
  @Schema(description = "Name of the cloud provider for display purposes. It can contain any characters, including spaces. ")
   ...
   * @return name
  **/
  @Schema(description = "Human friendly identifier of the cloud provider, for example `aws`. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.kind, cloudProvider.kind) &&
        ...
        Objects.equals(this.href, cloudProvider.href) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(kind, id, href, displayName, name);
  }
