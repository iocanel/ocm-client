...
public class InlineResponse2006 {
  @JsonProperty("items")
  private List<AddOnInstallation> items = null;
  ...
  public InlineResponse2006 items(List<AddOnInstallation> items) {
    this.items = items;
    return this;
  }

  public InlineResponse2006 addItemsItem(AddOnInstallation itemsItem) {
    if (this.items == null) {
   ...
   * @return items
  **/
  @Schema(description = "Retrieved list of add-on installations. ")
  public List<AddOnInstallation> getItems() {
    return items;
  }

  public void setItems(List<AddOnInstallation> items) {
    this.items = items;
  }
