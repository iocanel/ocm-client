...
public class InlineResponse20022 {
  ...
  public InlineResponse20022 items(List<Version> items) {
    this.items = items;
    return this;
  }

  public InlineResponse20022 addItemsItem(Version itemsItem) {
    if (this.items == null) {
   ...
   * @return items
  **/
  @Schema(description = "Retrieved list of versions. ")
  public List<Version> getItems() {
    return items;
  }

  public void setItems(List<Version> items) {
    this.items = items;
  }

  public InlineResponse20022 page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse20022 size(Integer size) {
    this.size = size;
    return this;
  }
   ...
   * @return size
  **/
  @Schema(description = "Maximum number of items that will be contained in the returned page.  Default value is `100`. ")
  ...
  public InlineResponse20022 total(Integer total) {
    this.total = total;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.items, inlineResponse20022.items) &&
        Objects.equals(this.page, inlineResponse20022.page) &&
        Objects.equals(this.size, inlineResponse20022.size) &&
        Objects.equals(this.total, inlineResponse20022.total);
  }
