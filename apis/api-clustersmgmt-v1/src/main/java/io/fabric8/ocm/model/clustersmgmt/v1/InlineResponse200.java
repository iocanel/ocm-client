...
public class InlineResponse200 {
  ...
  public InlineResponse200 items(List<AddOn> items) {
    this.items = items;
    return this;
  }

  public InlineResponse200 addItemsItem(AddOn itemsItem) {
    if (this.items == null) {
   ...
   * @return items
  **/
  @Schema(description = "Retrieved list of add-ons. ")
  public List<AddOn> getItems() {
    return items;
  }

  public void setItems(List<AddOn> items) {
    this.items = items;
  }
