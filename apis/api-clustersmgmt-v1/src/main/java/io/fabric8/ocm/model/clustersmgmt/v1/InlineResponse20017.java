...
public class InlineResponse20017 {
  ...
  public InlineResponse20017 items(List<Dashboard> items) {
    this.items = items;
    return this;
  }

  public InlineResponse20017 addItemsItem(Dashboard itemsItem) {
    if (this.items == null) {
   ...
   * @return items
  **/
  @Schema(description = "Retrieved list of dashboards. ")
  ...
  public InlineResponse20017 page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse20017 size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse20017 total(Integer total) {
    this.total = total;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.items, inlineResponse20017.items) &&
        Objects.equals(this.page, inlineResponse20017.page) &&
        Objects.equals(this.size, inlineResponse20017.size) &&
