...
public class InlineResponse20019 {
  @JsonProperty("items")
  private List<MachineType> items = null;
  ...
  public InlineResponse20019 items(List<MachineType> items) {
    this.items = items;
    return this;
  }

  public InlineResponse20019 addItemsItem(MachineType itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public void setItems(List<MachineType> items) {
    this.items = items;
  }

  public InlineResponse20019 page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse20019 size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse20019 total(Integer total) {
    this.total = total;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.items, inlineResponse20019.items) &&
        Objects.equals(this.page, inlineResponse20019.page) &&
        Objects.equals(this.size, inlineResponse20019.size) &&
        Objects.equals(this.total, inlineResponse20019.total);
  }
